    ...
    <nav id="sidebarMenu" class="sidebar d-lg-block bg-gray-800 text-white collapse" data-simplebar>
        <div class="sidebar-inner px-4 pt-3">
            ...
            <ul class="nav flex-column pt-3 pt-md-0">
                    ...
                    <span class="mt-2 d-flex justify-content-between">
                        <span>
                            <span class="sidebar-icon">
                                ...
                                class="bi bi-pc-display-horizontal me-4 ms-4" viewBox="0 0 16 16">
                                    <path d="M1.5 0A1.5 1.5 0 0 0 0 1.5v7A1.5 1.5 0 0 0 1.5 10H6v1H1a1 1 0 0 0-1 1v3a1 1 0 0 0 1 1h14a1 1 0 0 0 1-1v-3a1 1 0 0 0-1-1h-5v-1h4.5A1.5 1.5 0 0 0 16 8.5v-7A1.5 1.5 0 0 0 14.5 0h-13Zm0 1h13a.5.5 0 0 1 .5.5v7a.5.5 0 0 1-.5.5h-13a.5.5 0 0 1-.5-.5v-7a.5.5 0 0 1 .5-.5ZM12 12.5a.5.5 0 1 1 1 0 .5.5 0 0 1-1 0Zm2 0a.5.5 0 1 1 1 0 .5.5 0 0 1-1 0ZM1.5 12h5a.5.5 0 0 1 0 1h-5a.5.5 0 0 1 0-1ZM1 14.25a.25.25 0 0 1 .25-.25h5.5a.25.25 0 1 1 0 .5h-5.5a.25.25 0 0 1-.25-.25Z"/>
                                </svg>
                            </span>
                            <span class="sidebar-text fw-bold">CBT ONLINE</span>
                        </span>
                    </span>
                </li>
                ...
                <li class="nav-item" :class="{ 'active': $page.url.startsWith('/admin/levels') }">
                    <Link href="/admin/levels" class="nav-link d-flex justify-content-between">
                    <span>
                        <span class="sidebar-icon">
                            <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="currentColor"
                        ...
                        <span class="sidebar-text">Jenjang</span>
                    </span>
                    </Link>
                </li>

                <li class="nav-item" :class="{ 'active': $page.url.startsWith('/admin/positions') }">
                    <Link href="/admin/positions" class="nav-link d-flex justify-content-between">
                    <span>
                        <span class="sidebar-icon">
                            <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="currentColor"
                ...
                <li role="separator" class="dropdown-divider mt-2 mb-2 border-gray-700"></li>
                        ...
                        <!-- <li class="nav-item" :class="{ 'active': $page.url.startsWith('/admin/appraisers') }">
                            <Link href="/admin/appraisers" class="nav-link d-flex justify-content-between">
                            <span>
                                <span class="sidebar-icon">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="currentColor"
                                        class="bi bi-people-fill icon icon-xs me-2" viewBox="0 0 16 16">
                                ...
                                <span class="sidebar-text">Tim Penilai</span>
                            </span>
                            </Link>
                        </li> -->
