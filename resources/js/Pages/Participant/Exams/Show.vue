<template>
    <Head>
        <title>Ujian Dengan Nomor Soal : {{ page }} - Aplikasi CBT Online</title>
    </Head>
    <div class="row mb-5">
        <div class="col-md-7">
    ...
    export default {
        ...
        setup(props) {
            ...
            const prevPage = (() => {
                ...
                Inertia.get(`/participant/exam/${props.id}/${props.page - 1}`);
            ...
            const clickQuestion = ((index) => {
                ...
                //redirect to questin
                Inertia.get(`/participant/exam/${props.id}/${index + 1}`);
            });

            //method submit answer
            const submitAnswer = ((exam_id, question_id, answer) => {

                Inertia.post('/participant/exam-answer', {
                    exam_id: exam_id,
            ...
            const endExam = (() => {
                ...
                Inertia.post('/participant/exam-end', {
