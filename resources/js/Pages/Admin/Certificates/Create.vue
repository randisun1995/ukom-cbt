<template>
    <Head>
        <title>Tambah Sertifikat - Aplikasi CBT Online</title>
    </Head>
    <div class="container-fluid mb-5 mt-5">
        <div class="row">
            <div class="col-md-12">
                <Link href="/admin/certificates" class="btn btn-md btn-primary border-0 shadow mb-3" type="button"><i class="fa fa-long-arrow-alt-left me-2"></i> Kembali</Link>
                <div class="card border-0 shadow">
                    <div class="card-body">
                        <h5><i class="fa fa-clone"></i> Tambah Sertifikat</h5>
                        <hr>
    ...
    export default {
        ...
        setup() {
            ...
            const submit = () => {
                ...
                //send data to server
                Inertia.post('/admin/certificates', {
                    //data
                    nip: form.nip,
                    title: form.title,
                    link: form.link,
                    ...
                    onSuccess: () => {
                        ...
                        Swal.fire({
                            title: 'Success!',
                            text: 'Sertfikat Berhasil Disimpan!.',
                            icon: 'success',
