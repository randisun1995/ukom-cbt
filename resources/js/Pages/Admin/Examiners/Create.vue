                                ...
                                <div class="col-md-6">
                                    <div class="mb-4">
                                        ...
                                        <select class="form-select" v-model="form.examsession_id" >
                                            <option v-for="(examsession, index) in filteredExamsessions" :key="index" :value="examsession.id" >{{ examsession.title }} {{ examsession.exam.position.title }} {{ examsession.exam.position.level.title }}</option>
                                        </select>
