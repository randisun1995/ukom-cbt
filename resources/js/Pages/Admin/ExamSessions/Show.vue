<template>
    <Head>
        <title>Detail Sesi Ujian - Aplikasi CBT Online</title>
    </Head>
            ...
            <div class="col-md-12">
                ...
                <div class="card border-0 shadow">
                    <div class="card-body">
                        ...
                        <Link :href="`/admin/exam_sessions/${exam_session.id}/enrolle/create`" class="btn btn-md btn-primary border-0 shadow me-2" type="button"><i class="fa fa-user-plus"></i> Enrolle Peserta</Link>
