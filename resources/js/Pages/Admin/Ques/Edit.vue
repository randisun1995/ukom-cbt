<template>
    ...
    <div class="container-fluid mb-5 mt-5">
        <div class="row">
            <div class="col-md-12">
                <Link :href="`/admin/questions`" class="btn btn-md btn-primary border-0 shadow mb-3" type="button"><i class="fa fa-long-arrow-alt-left me-2"></i> Kembali</Link>
                        ...
                        <form @submit.prevent="submit">
                            ...
                            <div class="table-responsive mb-4">
                                <table class="table table-bordered table-centered table-nowrap mb-0 rounded">
                                    <tbody>
                                        <tr>
                                            <td style="width:20%" class="fw-bold">Level Ujian</td>
                                            <td>
                                                <select class="form-select" v-model="form.exam_id">
                                                    <option v-for="(exam, index) in exam" :key="index" :value="exam.id">{{ exam.title }}</option>
                                                </select>
    ...
    export default {
        ...
        setup(props) {
            ...
            const submit = () => {
                ...
                //send data to server
                Inertia.put(`/admin/questions/${props.question.id}/update`, {
                    //data
