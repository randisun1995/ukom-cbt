<template>
    <Head>
        <title>Import Soal Ujian - Aplikasi CBT Online</title>
    </Head>
    <div class="container-fluid mb-5 mt-5">
        <div class="row">
            <div class="col-md-12">
                <Link :href="`/admin/questions`" class="btn btn-md btn-primary border-0 shadow mb-3 me-3" type="button"><i
    ...
    export default {
        ...
        setup(props) {
            ...
            const submit = () => {
                ...
                //send data to server
                Inertia.post(`/admin/questions/import`, {
                    //data
                    file: form.file,
                }, {
                    onSuccess: () => {
