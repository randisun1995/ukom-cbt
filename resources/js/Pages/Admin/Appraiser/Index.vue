<template>
    <Head>
        <title>Tim Penilai - Aplikasi CBT Online</title>
    </Head>
                    ...
                    <div class="col-md-5 col-12 mb-2">
                        <div class="row">
                            <div class="col-md-6 col-12 mb-2">
                                <Link href="/admin/appraisers/create" class="btn btn-md btn-primary border-0 shadow w-100"
                ...
                Swal.fire({
                    ...
                    .then((result) => {
                        if (result.isConfirmed) {
                            ...
                            Inertia.delete(`/admin/appriasers/${id}`);
