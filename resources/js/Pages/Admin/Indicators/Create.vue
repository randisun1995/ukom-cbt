<template>
    <Head>
        <title>Tambah Indikator Penilaian - Aplikasi CBT Online</title>
    </Head>
    <div class="container-fluid mb-5 mt-5">
        <div class="row">
            <div class="col-md-12">
                <Link href="/admin/indicators" class="btn btn-md btn-primary border-0 shadow mb-3" type="button"><i class="fa fa-long-arrow-alt-left me-2"></i> Kembali</Link>
                <div class="card border-0 shadow">
                    <div class="card-body">
                        <h5><i class="fa fa-user"></i> Tambah Indikator Penilaian</h5>
                        <hr>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="mb-4">
                                        ...
                                        <select class="form-select" v-model="form.cathegory">
            ...
            const submit = () => {
                ...
                Inertia.post('/admin/indicators', {
                    ...
                    onSuccess: () => {
                        ...
                        Swal.fire({
                            title: 'Success!',
                            text: 'Indikator Penilaian Berhasil Disimpan.',
                            icon: 'success',
