                            ...
                            <table class="table table-bordered table-centered table-nowrap mb-0 rounded">
                                <thead class="thead-dark">
                                    <tr class="border-0">
                                        ...
                                        <th class="border-0 rounded-end" style="width:15%">Berikan Penilaian</th>
                                    </tr>
                                </thead>
                                <div class="mt-2"></div>
                                <tbody>
                                    <tr v-for="(examinergroup, index) in examinergroups.data" :key="index">
                                        ...
                                        <td>{{ examinergroup.participant.type }} {{ examinergroup.status }}</td>
                                        <td class="text-center">
                                            <Link v-if="examinergroup.status === 0" :href="`/examiners/interviews/create/${examinergroup.id}`"
                                                class="btn btn-sm btn-info border-0 shadow me-2"
                                                type="button">
                                                <i class="fa fa-pencil-alt"></i>
                                            </Link>
                                            <Link v-else :href="`/examiners/interviews/${examinergroup.id}/edit`" class="btn btn-sm btn-success border-0 shadow me-2"
                                                type="button">
